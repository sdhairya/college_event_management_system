...
class registration extends StatelessWidget {
  ...
  Future signUp(String _signUpEmailController,String _signUpPasswordController, String _signUpNameController) async {
    // setState(() => isLoading = false);
    try {
      await FirebaseAuth.instance.createUserWithEmailAndPassword(
          email: _signUpEmailController,
      ...
      // });
      insertUser(_signUpEmailController,_signUpNameController);
  ...
  Future insertUser(String _signUpEmailController, String _signUpNameController) async {
