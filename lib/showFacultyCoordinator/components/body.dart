...
import 'package:college_event_management/showFacultyCoordinator/components/showFacultyCoordinator_components.dart';
...
class _bodyState extends State<body> {
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: showFacultyCoordinator_components().text("Show Faculty Coordinators", FontWeight.bold, Color(0xFF1D2A3A), 30),
                      ),
                      const SizedBox(
                        height: 20,
                      ),
                      Container(
                        child: buildListWithoutScroll(listfaculty),
                      )
                    ],
                  ),
                ),
      ...
      child: ListTile(
          ...
          ListTile(horizontalTitleGap: 15,
              ...
              leading: CircleAvatar(
                ...
                child: showFacultyCoordinator_components().text(element.firstName[0], FontWeight.bold, Colors.white, 25),
              ),
              title: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  showFacultyCoordinator_components().text(element.firstName +" "+ element.lastName, FontWeight.bold, Color(0xFF1D2A3A), 20),
                  SizedBox(height: 5,),
                  showFacultyCoordinator_components().text(element.email, FontWeight.normal, Color(0xFF1D2A3A), 14),
                  SizedBox(height: 5,),
                  showFacultyCoordinator_components().text(element.mobile, FontWeight.normal, Color(0xFF1D2A3A), 14),
                ],
              ),
              trailing: InkWell(
                child: Icon(Icons.delete,size: 30,color: Color(0xFF1D2A3A),),
                onTap: () {
                  deleteFacultyCoordinator(element.sid);
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(
                          builder: (context) =>
                              showFacultyCoordinator()));
  ...
  Future deleteFacultyCoordinator(String id) async {
    try {
      final url =
